...
Type monotonesmoothingmulti(objective_function<Type>* obj) {
  ...
  // Dimensions have to be provided, they cannot be inferred from the provided data
  ...
  // Now do it for the unconstrained smooths, a little more complicated
  int tmpidx=0;
  ...
  Type logprior = GMRF(Dpmono)(betaRmono) + GMRF(Dpsmooth)(betaRsmooth); // Negative! Note: doing manually not faster
