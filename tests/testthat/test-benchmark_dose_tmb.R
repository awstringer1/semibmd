test_that("benchmark dosing works with TMB", {
  ...
  expect_lt(abs(get_bmd(mod1_tmb)[1] - 0.1038671),1e-06)
  expect_lt(abs(get_bmd(mod1_tmb)[2] - 0.05721550),1e-06)
  
  expect_lt(abs(get_bmd(mod2_tmb)[1] - 0.14170031),1e-06)
  expect_lt(abs(get_bmd(mod2_tmb)[2] - 0.06973709),1e-06)
